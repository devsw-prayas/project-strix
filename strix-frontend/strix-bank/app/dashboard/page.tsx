import {MOCK_NODES} from "@/app/data/mock-nodes";
            ...
            <div className=" max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <ActiveNodesList nodes={MOCK_NODES as any} />
                        <RecentTransactions items={MOCK_TXS as any} />
                    </div>

                    <aside className="lg:col-span-1 space-y-4">
                        <ProfileCard user={{ name: "Demo User", email: "demo@strix", nodesOwned: 3 }} />
                        <TransactionsToday items={MOCK_TXS as any} />
